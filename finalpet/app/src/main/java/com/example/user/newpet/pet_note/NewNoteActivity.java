package com.example.user.newpet.pet_note;
...
public class NewNoteActivity extends AppCompatActivity {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(content)) {
                    ...
                    Snackbar.make(view, "請寫內容", Snackbar.LENGTH_SHORT).show();
                }
                        ...
                        newNoteRef.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(NewNoteActivity.this, "記錄添加到資料庫", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(NewNoteActivity.this, "錯誤: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.new_note_delete_btn:
                if (isExist) {
                    ...
                    Toast.makeText(this, "刪除未成功", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    ...
    private void deleteNote() {
        ...
        fNotesDatabase.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(NewNoteActivity.this, "紀錄已刪除", Toast.LENGTH_SHORT).show();
                    noteID = "no";
                    finish();
                } else {
